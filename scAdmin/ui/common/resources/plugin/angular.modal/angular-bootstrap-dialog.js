  ...
  .directive('modalWindow', ['$modalStack', '$timeout', function ($modalStack, $timeout) {
      return {
          ...
          link: function (scope, element, attrs) {
              ...
              scope.left = ($(window).width() / 2 - (attrs.width ? attrs.width : 1000) / 2) + "px";
              scope.margin_left = "0px";
  ...
  .factory('$modalStack', ['$document', '$compile', '$rootScope', '$$stackedMap',
    function ($document, $compile, $rootScope, $$stackedMap) {
        ...
        $modalStack.open = function (modalInstance, modal) {
            ...
            angularDomEl.attr('index', mi);
            angularDomEl.attr('width', modal.width);
            angularDomEl.attr('height', modal.height);
            angularDomEl.attr('title', modal.title);
            angularDomEl.attr('role', 'dialog');
...
angular.module("template/modal/window.html", []).run(["$templateCache", function ($templateCache) {
    ...
    "<div class=\"modal fade {{ windowClass }}\" ng-class=\"{in: animate}\" ng-style=\"{'z-index': 1050 + index*10,'width':width,'left':left,'margin-left':margin_left}\" ng-transclude></div>");
} ]);
// $templateCache.put("template/modal/window.html",
//    "<div class=\"modal fade {{ windowClass }}\" ng-class=\"{in: animate}\" ng-style=\"{'z-index': 1050 + index*10}\"><div class=\"modal\" ng-style=\"{'width':width}\">" +
//    "<div class=\"modal-dialog\">" +
//        "<div class=\"modal-content\">" +
//            "<div class=\"modal-header\">" +
//                "<button type=\"button\" class=\"close\" aria-hidden=\"true\" ng-click=\"closemodal()\"> &times;</button>" +
//                "<h3 class=\"modal-title\">" +
//                    "<span class=\"glyphicon glyphicon-star\"></span>{{title}}</h3>" +
//            "</div></div><div class=\"modal-body\" ng-style=\"{'max-height':height}\" ng-transclude></div></div></div></div>");
//} ]);
