$(function() {
    ...
    $("#search_input").keydown(function(event) {
        ...
        if (key == 38 || key == 40) {
            ...
            var chose = $("#search_box").children(".on").children("http://www.sucaihuo.com/Public/js/span.red").text();
    ...
    $("#search_input").keyup(function(event) {
        ...
        if (keyword != "" && keyword != "请输入搜索内容") {
            var li = "<a href='http://www.sucaihuo.com/Public/js/" + getUrl("") + "search.html?keyword=" + keyword + "&mtype=2' data-mtype=2> 搜索含<span class='red'>" + keyword + "</span>的jQuery特效</a>\n   <a href='http://www.sucaihuo.com/Public/js/" + getUrl("") + "search.html?keyword=" + keyword + "&mtype=1' data-mtype=1> 搜索含<span class='red'>" + keyword + "</span>的网站模板</a>\n<a href='http://www.sucaihuo.com/Public/js/" + getUrl("") + "search.html?keyword=" + keyword + "&mtype=20' data-mtype=20> 搜索含<span class='red'>" + keyword + "</span>的PHP源码</a>\n<a href='http://www.sucaihuo.com/Public/js/" + getUrl("") + "search.html?keyword=" + keyword + "&mtype=15' data-mtype=15> 搜索含<span class='red'>" + keyword + "</span>的整站源码</a>\n<a href='http://www.sucaihuo.com/Public/js/" + getUrl("") + "search.html?keyword=" + keyword + "&mtype=30' data-mtype=30> 搜索含<span class='red'>" + keyword + "</span>的视频教程</a>\n<a href='http://www.sucaihuo.com/Public/js/" + getUrl("") + "search.html?keyword=" + keyword + "&mtype=21' data-mtype=21> 搜索含<span class='red'>" + keyword + "</span>的话题</a>";
    ...
    $("#search_input").focus(function(event) {
        ...
        var keyword = $(this).val();
        if (keyword != "" && keyword != "请输入搜索内容") {
            var li = "<a href='http://www.sucaihuo.com/Public/js/" + getUrl("") + "search.html?keyword=" + keyword + "&mtype=2' data-mtype=2> 搜索含<span class='red'>" + keyword + "</span>的jQuery特效</a>\n   <a href='http://www.sucaihuo.com/Public/js/" + getUrl("") + "search.html?keyword=" + keyword + "&mtype=1' data-mtype=1> 搜索含<span class='red'>" + keyword + "</span>的网站模板</a>\n<a href='http://www.sucaihuo.com/Public/js/" + getUrl("") + "search.html?keyword=" + keyword + "&mtype=20' data-mtype=20> 搜索含<span class='red'>" + keyword + "</span>的PHP</a>\n<a href='http://www.sucaihuo.com/Public/js/" + getUrl("") + "search.html?keyword=" + keyword + "&mtype=15' data-mtype=15> 搜索含<span class='red'>" + keyword + "</span>的整站源码</a>\n<a href='http://www.sucaihuo.com/Public/js/" + getUrl("") + "search.html?keyword=" + keyword + "&mtype=30' data-mtype=30> 搜索含<span class='red'>" + keyword + "</span>的视频教程</a>\n<a href='http://www.sucaihuo.com/Public/js/" + getUrl("") + "search.html?keyword=" + keyword + "&mtype=21' data-mtype=21> 搜索含<span class='red'>" + keyword + "</span>的话题</a>";
            $("#search_box").html(li).removeClass("hide")
        } else {
            $("#search_box").html("").addClass("hide")
        }
    ...
    // if ($("http://www.sucaihuo.com/Public/js/img.lazy").length > 0) {
    //     $("http://www.sucaihuo.com/Public/js/img.lazy").lazyload({
    //         effect: "fadeIn"
    //     })
    // }
    if ($(".emotion").length > 0) {
...
function showWindowBox() {
    $.post(getUrl("Box/logins"), {}, function(data) {
        $("#windown_box").html(data).modal("show").css({
            "width": "460px",
            "marginLeft": "-230px"
        })
    })
    ...
    $.post(getUrl("Index/shareWeibo"), {
        ...
        if (data.ret == -1) {
            ...
            if (data.ret == "100030") {
                ...
                location.href = "https://graph.qq.com/oauth2.0/authorize?client_id=101200983&redirect_uri=http%3A%2F%2Fwww.sucaihuo.com%2FIndex%2Fcallback%3Ftype%3Dqq&response_type=code&scope=get_user_info%2Cadd_share%2Cadd_t%2Cadd_pic_t"
            } else {
                if (data.ret == "0") {
