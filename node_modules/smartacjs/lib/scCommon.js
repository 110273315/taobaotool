...
{
    var logPath=os.type()=="Linux"?"/var/log/smartac/node/":"$(CurrentDirectory)/../log/";
...
var appInit = function (confFile) {
    ...
    try {
        ...
        if (g_app.conf.logFile==null || g_app.conf.logFile==undefined)
        {
            ...
            {
                g_app.conf.logPath=os.type()=="Linux"?"/var/log/smartac/node/":"$(CurrentDirectory)/../log/";
            }
...
if (!exports.isDebug)
{
    ...
    process.on('exit', function (exitCode) {
        console.warn('process exit with code: %s', exitCode);
    });
}
// 获取RabbitMQ库
...
exports.Redis = function(){
    try {
        return require("./scRedis");
    } catch (e) {
        console.error("cann't load scRedis.js!error=%s",e);
        return undefined;
    }
}
//获取Redis
