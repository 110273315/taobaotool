...
RedisConnection.prototype.incrby = function (key,count) {
    var　self=this;
    return new Promise(function(resolve, reject){
        if (!self.isConnected()) {
            self.log.error('connection closed!');
        ...
        self._redisconn.incrby(key,count).then(function(data){
            resolve(data);
        }).catch(function(e){
            reject(e);
        });
...
RedisConnection.prototype.decr = function (key) {
    var　self=this;
    return new Promise(function(resolve, reject){
        if (!self.isConnected()) {
            self.log.error('connection closed!');
        ...
        self._redisconn.decr(key).then(function(data){
            resolve(data);
        }).catch(function(e){
            reject(e);
        });
...
RedisConnection.prototype.decrby = function (key,count) {
    var　self=this;
    return new Promise(function(resolve, reject){
        if (!self.isConnected()) {
            self.log.error('connection closed!');
        ...
        self._redisconn.decrby(key,count).then(function(data){
            resolve(data);
        }).catch(function(e){
            reject(e);
        });
